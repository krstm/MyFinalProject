...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        {
            IResult result = BusinessRules.Run(CheckIfProductCoutOfCategoryCorrect(product.CategoryId),
        ...
        private IResult CheckIfProductCoutOfCategoryCorrect(int categoryId)
        {
